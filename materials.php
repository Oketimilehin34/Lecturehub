        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto">
             <li class="nav-item active">
                <a class="nav-link text-gray" href="index.php">Home<span class="visually-hidden"></span></a>
             </li>
             <li class="nav-item">
...
<head>
  <meta charset="utf-8">
  <title>All Lecture Materials</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>

<div class="container py-5">
  <h2 class="mb-4 text-center">Lecture_Materials</h2>
  <div class="row g-4">
    <?php
...
if (performance.navigation.type === 1) {
  const referrer = localStorage.getItem("referrerPage");
  if (referrer) {
